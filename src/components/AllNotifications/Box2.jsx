...
const Box2 = () => {
  return (
    <Box sx={{display:'flex',marginTop:'.4rem', alignItems:'center',justifyContent:'start', padding:'8px 10px', gap:'20px',width:'80%', backgroundColor:'rgba(233, 239, 240,0.5)' }}>
      ...
      <Box>
        <Box><Typography fontSize='14px'><span style={{fontWeight:'bold', color:'#1a2547', cursor:'pointer',}}>Angela Gray</span><span style={{color:'grey'}}> followed you</span></Typography></Box>
